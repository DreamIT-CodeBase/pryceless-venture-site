...
const gridVariants = {
  compact: {
    ...
    cardClassName:
      "group flex h-full min-h-[286px] min-w-0 w-full flex-col items-center rounded-[18px] border px-4 pb-6 pt-7 text-center shadow-[0_2px_8px_rgba(24,36,63,0.03)] pv-interactive-card transition-[transform,box-shadow] duration-300 sm:min-h-[314px] sm:px-[14px] sm:pt-[33px] sm:pb-[25px]",
    iconShellClassName:
    ...
    buttonClassName:
      "mt-auto flex min-h-[39px] w-full max-w-[180px] items-center justify-center rounded-[4px] bg-[#16324d] px-4 py-2 text-[13.5px] font-semibold tracking-[-0.01em] !text-white pv-interactive-button transition-[box-shadow,transform] duration-300 group-hover:-translate-y-[1px] group-hover:shadow-[0_14px_26px_rgba(17,40,62,0.16)] hover:!text-white visited:!text-white",
  ...
  spacious: {
    ...
    cardClassName:
      "group flex h-full min-h-[308px] min-w-0 w-full flex-col items-center rounded-[18px] border px-4 pb-6 pt-8 text-center shadow-[0_2px_8px_rgba(24,36,63,0.03)] pv-interactive-card transition-[transform,box-shadow] duration-300 sm:min-h-[354px] sm:px-[18px] sm:pt-[37px] sm:pb-[30px] 2xl:min-h-[372px]",
    iconShellClassName:
    ...
    buttonClassName:
      "mt-auto flex min-h-[44px] w-full max-w-[196px] items-center justify-center rounded-[4px] bg-[#16324d] px-4 py-2 text-[14px] font-semibold tracking-[-0.01em] !text-white pv-interactive-button transition-[box-shadow,transform] duration-300 group-hover:-translate-y-[1px] group-hover:shadow-[0_14px_26px_rgba(17,40,62,0.16)] hover:!text-white visited:!text-white sm:text-[15px]",
