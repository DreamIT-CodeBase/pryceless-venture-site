...
const gridVariants = {
  ...
  spacious: {
    ...
    cardClassName:
      "flex min-h-[308px] flex-col items-center rounded-[18px] border px-4 pb-6 pt-8 text-center shadow-[0_2px_8px_rgba(24,36,63,0.03)] sm:min-h-[354px] sm:px-[18px] sm:pt-[37px] sm:pb-[30px] 2xl:min-h-[372px]",
    iconShellClassName:
