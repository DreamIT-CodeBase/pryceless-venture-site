...
const gridVariants = {
  compact: {
    ...
    cardClassName:
      "flex min-h-[286px] flex-col items-center rounded-[18px] border px-4 pb-6 pt-7 text-center shadow-[0_2px_8px_rgba(24,36,63,0.03)] sm:min-h-[314px] sm:px-[14px] sm:pt-[33px] sm:pb-[25px]",
    iconShellClassName:
  ...
  spacious: {
    sectionClassName: "mx-auto w-full max-w-[1440px] bg-white px-4 pb-[56px] pt-[56px] sm:px-6 sm:pb-[62px] sm:pt-[74px] lg:px-[125px]",
    gridClassName: "mx-auto grid max-w-[1074px] gap-4 sm:grid-cols-2 sm:gap-[20px] xl:grid-cols-4",
    cardClassName:
      "flex min-h-[308px] flex-col items-center rounded-[18px] border px-4 pb-6 pt-8 text-center shadow-[0_2px_8px_rgba(24,36,63,0.03)] sm:min-h-[354px] sm:px-[18px] sm:pt-[37px] sm:pb-[30px]",
    iconShellClassName:
