...
export function ThreeUpCollectionGrid({
  ...
  const resolvedClassName =
    "mx-auto w-full xl:max-w-[var(--three-up-max-width)] min-[1400px]:max-w-[var(--three-up-max-width-2xl)]";
  const gridStyle = {
...
export function StandardCollectionCard({
  ...
  const resolvedClassName =
    `flex h-full min-h-[420px] flex-col overflow-hidden rounded-[18px] border border-[rgba(215,215,215,1)] bg-white pv-interactive-card transition-[transform,box-shadow,border-color] duration-300 hover:border-[rgba(24,49,75,0.18)] sm:min-h-[484px] ${className}`.trim();
...
export function StandardCollectionCardLink({
  ...
  const resolvedClassName =
    `group flex h-full min-h-[420px] min-w-0 w-full flex-col overflow-hidden rounded-[18px] border border-[rgba(215,215,215,1)] bg-white pv-interactive-card transition-[transform,box-shadow,border-color] duration-300 hover:border-[rgba(24,49,75,0.18)] sm:min-h-[484px] ${className}`.trim();
