...
async function seedHomePage() {
  await prisma.homePage.upsert({
    ...
    update: {
      ...
      aboutSectionTitle: homePageSeed.aboutSectionTitle,
      aboutSectionParagraphOne: homePageSeed.aboutSectionParagraphOne,
      aboutSectionParagraphTwo: homePageSeed.aboutSectionParagraphTwo,
      aboutSectionPrimaryCtaLabel: homePageSeed.aboutSectionPrimaryCtaLabel,
      aboutSectionPrimaryCtaHref: homePageSeed.aboutSectionPrimaryCtaHref,
      aboutSectionSecondaryCtaLabel: homePageSeed.aboutSectionSecondaryCtaLabel,
      aboutSectionSecondaryCtaHref: homePageSeed.aboutSectionSecondaryCtaHref,
      aboutSectionImageUrl: homePageSeed.aboutSectionImageUrl,
      aboutSectionImageAlt: homePageSeed.aboutSectionImageAlt,
